...
class Discussion extends Phaser.Scene {
  constructor() { super({key : 'discussion'}); }
  preload() {}
  ...
  create() {
    ...
    this.input.once(
        'pointerdown',
        function() { Object.keys(mansion.getOtherPlayers()).forEach(o => {}); },
        this);
  }
}
export default Discussion;

// TODO can be cleaned up and adapted for just this scene (i.e. get rid of the
// check to see if discussion is visible)
